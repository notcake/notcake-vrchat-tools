...
namespace notcake.Unity.UnityPrefabFileIDDiff.Tests.Program
{
    ...
    /// <summary>
    ///     Tests for <see cref="notcake.Unity.UnityPrefabFileIDDiff"/>'s handling of unreadable
    ///     file paths.
    /// </summary>
    [TestClass]
        ...
        notcake.Unity.Prefab.Tests.Resources.UnreadableFilePathTests
    {
        ...
        public void UnreadableLeftPrefabFilePath(string path, string error)
        {
        ...
        public void UnreadableRightPrefabFilePath(string path, string error)
        {
            TestConsole testConsole = new();
            int exitCode = Program.RootCommand.Invoke(
